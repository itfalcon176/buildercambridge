          ...
          <AnimatePresence>
            {displayedServices.map((service, index) => (
              <motion.div
                ...
                className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-md hover:shadow-2xl hover:border-amber-400 transition-all duration-300 group flex flex-col justify-between"
              >
                <div>
                  {/* Image Container */}
                  <div className="relative h-56 w-full overflow-hidden bg-slate-100">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 rounded-full bg-[#092457]/80 backdrop-blur-md text-amber-300 text-[11px] font-bold tracking-wide border border-blue-900/50">
                        {service.category}
                      </span>
                    </div>
                    ...
                    {service.badge && (
                      <div className="absolute top-4 right-4">
                        <span className="px-3 py-1 rounded-full bg-amber-500 text-slate-950 text-[11px] font-black tracking-wide shadow-md">
                          {service.badge}
                        </span>
                      </div>
                    )}
                  ...
                  <div className="p-6 space-y-4">
                    <h3 className="text-xl font-bold text-[#092457] group-hover:text-amber-600 transition-colors font-sans">
